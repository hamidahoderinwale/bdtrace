...
\textcolor{blue}{Applied across all ten agents (Figure~\ref{fig:jsd_full}), pairwise JSD shows the distilled child sitting closest to its teacher (JSD 0.10) while the same model under two scaffolds diverges most (0.49)---scaffold outweighs training lineage in procedural impact.}
