def raw_repr(trace: dict, include_metadata: bool = True) -> dict:
    """Extract raw representation: code changes, prompts, metadata."""
    result = {
        "code_changes": [],
        "prompts": [],
    }
...
def raw_repr_str(trace: dict, include_metadata: bool = True) -> str:
    """Get raw representation as a formatted string."""
    raw = raw_repr(trace, include_metadata)
    parts = []
